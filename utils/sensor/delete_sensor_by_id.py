from sc_client.client import search_links_by_contents, search_by_template, erase_elements
from sc_client.constants import sc_type
from sc_client.models import ScLinkContent, ScLinkContentType, ScConstruction, ScTemplate
from sc_kpm import ScKeynodes

def delete_sensor_by_id(id: str) -> bool:
    ...
    templ = ScTemplate()
    templ.triple(
        ScKeynodes.resolve("concept_sensor", sc_type.VAR_NODE),
    ...
    erase_elements(search_results[0].get("_sensor"))
    return True